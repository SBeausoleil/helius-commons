...
import systems.helius.commons.reflection.CachingClassInspector;
...
class AccessorsChainTest {
    ...
    private abstract static class NoopAccessor implements ContentAccessor {
        ...
        public Collection<Content> extract(Object current, java.lang.reflect.Field holdingField,
                                           systems.helius.commons.reflection.IntrospectionContext<?> context,
                                           systems.helius.commons.reflection.IntrospectionSettings settings) {
